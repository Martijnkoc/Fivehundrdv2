...
| Open/close choreography (scroll, notch, ghost, drag, back), fly-to-card, audio, index strip, Create | `app/wall/legacy.js`, the rest of the prototype script, still to port |
